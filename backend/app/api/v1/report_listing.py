...
async def generate_scan_report(
    ...
    return _scan_report(db, current_user.current_organization_id, request.scan_id)
...
async def export_scan_report(
    ...
    report = _scan_report(db, current_user.current_organization_id, scan_identifier)
