...
def _owned_schedule(db: Session, user_id: str, schedule_id: str) -> ScanSchedule:
...
async def mail_status(current_user=Depends(get_current_user)):
...
async def toggle_schedule(
    ...
    schedule = _owned_schedule(db, current_user.id, schedule_id)
