  ...
  return (
    <ResponsiveContainer width="100%" height={220}>
      <AreaChart data={data} margin={{ top: 5, right: 5, bottom: 0, left: 0 }}>
        ...
        <Area type="monotone" dataKey="vulnerabilities" name="Vulnerabilities"
          stroke="#ef4444" fill="url(#colorVuln)" strokeWidth={1.5} dot={false} />
        <Area type="monotone" dataKey="scans" name="Scans"
          stroke="#3b82f6" fill="url(#colorScans)" strokeWidth={1.5} dot={false} />
      </AreaChart>
    </ResponsiveContainer>
  )
}
...
export function ScanStatsChart({ data }: { data: any }) {
